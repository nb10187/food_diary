...
MEDIA_ROOT = '/var/www/foody/food_diary/bootstrap/uploaded_files'#'/home/jef/foody'#os.path.join(ROOT_PATH, 'media')
...
SECRET_KEY = '5yool*s5%7qx#kfr0$r==zpn@t&a03he^58z+66e*su9b0w+x^'
...
ROOT_URLCONF = 'fooddiary.apache.urls_production'
